...
- Decision V9.24 : `aggtrades_post_v9_batch3_collection_success`.
- Justification : Les jours batches demandes ont ete collectes, normalises et valides sans etendre la collecte complete.
- Recommandation suivante : V9.25 - AggTrades Post-V9 Batch 4 Collection.
...
## Batch
- Periode batche : `2024-10-09` -> `2024-12-07`.
- Jours demandes : `60`.
- Jours tentes : `60`.
...
- Jours echoues : `0`.
- Jours quarantine : `0`.
- Lignes totales : `124227690`.
- Raw bytes total : `1553341925`.
- Silver bytes total : `3004532928`.
- Runtime secondes : `1251.3`.
- Alertes continuite aggregate_trade_id intra-batch : `0`.
- Couverture batch apres execution : `2024-10-09` -> `2024-12-07`.
- Couverture cumulee declaree : `2024-05-05` -> `2024-12-07`.
- Couverture locale reelle : `2024-05-05` -> `2024-12-07`.
...
- Raw bytes estimes : `19986332704`.
- Lignes estimees : `1598395892`.
- Runtime estime secondes : `16100.06`.

...
V3.1.10 est une correction test-reference-only. V3.1.9 a été refusée en strict parce que les tests V3.1 référaient encore `smoke_test_clean_zip_v3_1_8.py`, absent du ZIP V3.1.9.

V3.1.10 conserve les artefacts fonctionnels V3.1 : mêmes labels, mêmes horizons `[1, 3, 5]`, même threshold `0.0005`, mêmes row counts `10080 / 2016 / 672 / 168`, aucune jointure features + labels et aucun dataset ML. Les tests smoke V3.1 pointent désormais uniquement vers `smoke_test_clean_zip_v3_1_10.py`.

## Inputs

- Source : OHLCV V2.9 `data/research/v2_9/silver/ohlcv`
- Timeframes : `1m`, `5m`, `15m`, `1h`
- Run : `v3_1_20260521T175215Z_21afd162`

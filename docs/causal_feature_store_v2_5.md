# Galapagos V2.5.1 — Causal OHLCV Feature Store Preview (Correctif V2.5)

Ce document décrit l'architecture technique, les garanties causales, le schéma physique strict et les limitations de la version **V2.5.1 — Causal OHLCV Feature Store Preview** (mise à jour corrective de la V2.5).

> [!NOTE]
> La version V2.5.1 est une mise à jour corrective ciblant la reproductibilité totale de la suite de tests du validateur et la performance I/O des tests du validateur V2.4, sans aucune modification des indicateurs mathématiques calculés.

## 1. Contexte et Objectifs

La version V2.5 (corrigée en V2.5.1) introduit le premier Feature Store Preview de Galapagos. 
...
Afin d'éviter tout biais de look-ahead (surapprentissage ou fuite d'informations du futur), le Feature Store V2.5.1 met en place des garde-fous physiques stricts :
...
Le projet Galapagos V2.5.1 respecte les clauses réglementaires suivantes :
- V2.5.1 ne valide aucune stratégie.
- V2.5.1 ne produit aucun label.
- V2.5.1 ne produit aucun modèle ML.
- V2.5.1 ne produit aucun backtest.
- V2.5.1 ne produit aucun signal de trading.
- V2.5.1 ne produit aucun ordre.
- V2.5.1 n’autorise aucun paper live.
- V2.5.1 n’autorise aucun trading réel.
- La version candidate V2.5.1 reste en statut `pending_external_audit` avant toute validation externe finale.

...
OHLCV_TRADES_METADATA_COLUMNS_V7_2 = OHLCV_TRADES_FEATURE_COLUMNS_V7_2[:15]

OHLCV_TRADES_OHLCV_BASE_COLUMNS_V7_2 = [
    "open",
    "high",
    "low",
    "close",
...
OHLCV_TRADES_VALUE_COLUMNS_V7_2 = OHLCV_TRADES_FEATURE_COLUMNS_V7_2[15:]

OHLCV_TRADES_FEATURE_FAMILIES_V7_2 = {
    "ohlcv_base_reference": OHLCV_TRADES_OHLCV_BASE_COLUMNS_V7_2,
    "trade_aggregation": [
        "agg_trade_count",
        "agg_trade_quantity_sum",
        "agg_trade_quote_quantity_sum",

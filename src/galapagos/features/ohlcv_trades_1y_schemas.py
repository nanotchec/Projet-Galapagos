...
OHLCV_TRADES_METADATA_COLUMNS_V8_3 = OHLCV_TRADES_FEATURE_COLUMNS_V8_3[:15]

OHLCV_TRADES_OHLCV_BASE_COLUMNS_V8_3 = [
    "open",
    "high",
    "low",
    "close",
...
OHLCV_TRADES_VALUE_COLUMNS_V8_3 = OHLCV_TRADES_FEATURE_COLUMNS_V8_3[15:]

OHLCV_TRADES_FEATURE_FAMILIES_V8_3 = {
    "ohlcv_base_reference": OHLCV_TRADES_OHLCV_BASE_COLUMNS_V8_3,
    "trade_aggregation": [
        "agg_trade_count",
        "agg_trade_quantity_sum",
        "agg_trade_quote_quantity_sum",

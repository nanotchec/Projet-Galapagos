...
VERSION_V8_2 = "V8.2"
SCHEMA_VERSION_V8_2 = "AGG_TRADE_COLUMNS_V8_2"
...
DEFAULT_1Y_WINDOW_START_V8_2 = "2023-03-25"
DEFAULT_1Y_WINDOW_END_V8_2 = "2024-03-24"
...
DISCOVERY_JSON_PATH_V8_2 = Path("reports/data_quality/public_trades_1y_window_v8_2_discovery.json")
DISCOVERY_MD_PATH_V8_2 = Path("reports/data_quality/public_trades_1y_window_v8_2_discovery.md")
MANIFEST_PATH_V8_2 = Path("reports/manifests/public_trades_1y_window_v8_2_manifest.json")
REPORT_JSON_PATH_V8_2 = Path("reports/data_quality/public_trades_1y_window_v8_2.json")
REPORT_MD_PATH_V8_2 = Path("reports/data_quality/public_trades_1y_window_v8_2.md")
DOC_PATH_V8_2 = Path("docs/public_trades_1y_window_v8_2.md")
LIMITATIONS_V7_0 = [
...
def output_partition_path_v8_2(root: Path, window_start: str, window_end: str, date_value: str) -> Path:
    return (
        root

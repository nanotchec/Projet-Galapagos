...
ZIP_NAME = "projet-galapagos-v2.8.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_8_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_8_1.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du laboratoire ML offline V2.8.1.\n",
        encoding="utf-8",
    )

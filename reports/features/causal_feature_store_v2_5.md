...
- Statut : `PASS`
- Run ID : `v2_5_20260519T200253Z_8b042e12`
- Feature Schema Version : `V2.5`

## Lignes de features gold produites

- `1m` : `1440` features (Warmup: `30` lignes, Lignes actives après warmup: `1410`)
- `5m` : `288` features (Warmup: `30` lignes, Lignes actives après warmup: `258`)
- `15m` : `96` features (Warmup: `30` lignes, Lignes actives après warmup: `66`)
- `1h` : `24` features (Warmup: `24` lignes, Lignes actives après warmup: `0`)

# État du Projet : V2.7.2 validée + candidat V2.8.3
...
- V2.8.3 finalise le runtime des tests score via un helper pur en mémoire et rend le smoke silencieux sur les validateurs.
...
- V2.8.3 reste candidate `pending_external_audit`.
...
- V2.8.3 reste non validée avant audit externe.

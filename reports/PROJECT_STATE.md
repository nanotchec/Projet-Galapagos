# État du Projet : V3.3.1 validée + candidat V3.4
...
- V3.4 ne produit aucun backtest, aucune stratégie, aucun signal de trading, aucun ordre et aucun trading réel.
- V3.4 reste candidate `pending_external_audit`.
...
- Aucune API privée.
- Aucune clé API.
- V3.4 reste non validée avant audit externe.

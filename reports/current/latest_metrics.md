# Latest Metrics V2.3.1 + candidat V2.4.2
...
- V2.4.2 reste data-only, sans cle API, sans endpoint prive, sans trading, sans paper live, sans ordre, sans ML, sans labels et sans backtest.

...
- **Scope** : entraînement ML offline simple déjà produit en V2.8, avec correction V2.8.3 limitée au runtime des tests de score et au smoke silencieux.
...
- **Validation externe** : V2.8.3 n'est pas validée avant audit externe.

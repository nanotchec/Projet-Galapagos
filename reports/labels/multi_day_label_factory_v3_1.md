...
V3.1.6 est une correction smoke/test-only. V3.1.5 a été refusée en strict parce que le smoke lançait tous les validateurs sur le même root extrait, provoquant encore un timeout sur V2.8.

V3.1.6 conserve les artefacts fonctionnels V3.1 : mêmes labels, mêmes horizons `[1, 3, 5]`, même threshold `0.0005`, mêmes row counts `10080 / 2016 / 672 / 168`, aucune jointure features + labels et aucun dataset ML.

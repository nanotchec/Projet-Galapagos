...
V3.1.3 est une correction smoke-only. V3.1.2 a été refusée en strict uniquement parce que le smoke test V3.1.2 timeout.

V3.1.3 conserve les artefacts fonctionnels V3.1 : mêmes labels, mêmes horizons `[1, 3, 5]`, même threshold `0.0005`, mêmes row counts `10080 / 2016 / 672 / 168`, aucune jointure features + labels et aucun dataset ML.

## Inputs

- Source : OHLCV V2.9 `data/research/v2_9/silver/ohlcv`
- Timeframes : `1m`, `5m`, `15m`, `1h`
- Run : `v3_1_20260521T122751Z_5d751ab3`

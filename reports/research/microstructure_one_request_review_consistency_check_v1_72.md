# Microstructure One Request Review Consistency Check
...
```json
{
  ...
  "previous_response_status_code": 200,
  "previous_response_size_bytes": 1724,
  "previous_records_preview_count": 10,
  "previous_records_preview_count_lte_10": true,

# Canonical Universe Definition - V1.36.1
...
```json
{
  ...
  "ev_filter_reference_universe_definition": "historical reference selected trades using filter_ev_gt_cost_buffer logic (approx predicted_probability > 0.65)",
  "base_data": {

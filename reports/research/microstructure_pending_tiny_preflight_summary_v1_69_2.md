# Report: Microstructure Pending Tiny Preflight Summary

```json
{
  "version": "V1.69.2",
  "current_version": "V1.69.2",
  "previous_version": "V1.69.1",
  "previous_base": "V1.69.1",
  "microstructure_pending_tiny_preflight_base_version": "V1.69.1",
  "microstructure_tiny_network_approval_base_version": "V1.68",
  "canonical_base_version": "V1.37.2",
  "migrated_from": "V1.69.1",
  "migration_reason": "portable negative tests and final release hardening fix",
  ...
  "previous_final_verdict": "MICROSTRUCTURE_TINY_NETWORK_PREFLIGHT_APPROVAL_GATE_READY",

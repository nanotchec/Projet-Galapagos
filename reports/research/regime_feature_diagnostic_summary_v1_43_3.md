# Regime Feature Diagnostic Summary V1.43.3
...
```json
{
  ...
  "feature_inventory_status": "REGIME_FEATURE_INVENTORY_COMPLETE_WITH_STRICT_SOURCE_SEMANTICS",
  ...
  "regime_feature_interaction_status": "REGIME_FEATURE_INTERACTION_LIMITED",

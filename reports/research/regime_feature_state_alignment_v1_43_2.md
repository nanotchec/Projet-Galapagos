# Regime Feature State Alignment V1.43.2
...
```json
{
  ...
  "old_payoff_target_fields_removed_from_root": true,
  "purpose_corrected": true,
  "canonical_base_version_corrected": true,
  "consistency_check_status_aligned": true,
  "feature_source_semantics_aligned": true,

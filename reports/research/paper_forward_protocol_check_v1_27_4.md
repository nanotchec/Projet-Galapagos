# Paper Forward Protocol Check V1 27 4

```json
{
  "status": "PROTOCOL_CHECK_PASSED_REFERENCE_V1_26_6",
  "protocol": {
    "protocol_version": "v1.26.6",
    "protocol_created_from": "v1.26.5",
    ...
    "protocol_upgrade_reason": "archive_integrity_reference_protocol",
    "frozen_filter_definition_complete": true,
    "frozen_filter_definition_status": "FILTER_DEFINITION_COMPLETE_WITH_TIE_BREAK_WARNING",
    "frozen_filter_definition_hash": "de6b57ea813f5d4c79221ebc366647a61b08d286dc00934fedff20cc7fc654cd",
    ...
    "do_not_use_for_forward_validation": [
      "v1.26.2",
      "v1.26.3",
      "v1.26.4"
    ]

...
- Candidate : V3.1.2, finalisation runtime du validator V3.1 et smoke V3.1.2.
...
- V3.1.1 a ete refusee en strict pour runtime du fichier validator V3.1 et timeout smoke.
- V3.1.2 reste `pending_external_audit` et n'est pas validee avant audit externe.

...
- Candidate : V2.7.1, offline supervised dataset validator runtime finalization.
...
- V2.7.1 conserve les artefacts V2.7 et finalise le runtime du fichier complet de tests du validateur.
- V2.7.1 reste `pending_external_audit` et n'est pas validee avant audit externe.

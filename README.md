...
- Derniere version validee : V3.4.1.
- Candidate : V3.5, expansion data marche publique 90 jours.
...
- V3.5 ne produit aucune feature, aucun label, aucun dataset ML, aucun modele ML, aucun backtest, aucune strategie, aucun signal de trading, aucun ordre et aucun trading reel.
- V3.5 reste `pending_external_audit` et n'est pas validee avant audit externe.

...
- Derniere version validee : V2.7.2.
- Candidate : V2.8, first offline ML research baselines.
...
- V2.8 entraine uniquement des baselines ML offline simples, sans strategie et sans signal de trading.
- Aucun modele n'est valide pour une exploitation trading.
- V2.8 reste `pending_external_audit` et n'est pas validee avant audit externe.

...
- Candidate : V3.1.1, finalisation runtime/import de la label factory multi-day.
...
- V3.1 a ete refusee en strict uniquement pour runtime/import du validateur et des tests V3.1.
- V3.1.1 reste `pending_external_audit` et n'est pas validee avant audit externe.

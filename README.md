...
- Candidate : V2.7.2, offline supervised dataset validator runtime finalization.
...
- V2.7.2 conserve les artefacts V2.7 et impose un hard cap de 4 tests d'integration complete du validateur.
- V2.7.2 reste `pending_external_audit` et n'est pas validee avant audit externe.

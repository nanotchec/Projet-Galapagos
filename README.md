...
- Candidate : V6.4, advanced OHLCV research decision gate.
- Fenetre historique validee : `2023-03-25` -> `2026-05-23`, `1156` jours.
- Verdict V6.4 : advanced OHLCV interessant mais non concluant.
...
- V6.4 reste `pending_external_audit` et n'est pas validee avant audit externe.

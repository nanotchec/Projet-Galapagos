...
- Candidate : V7.1, public aggTrades expanded 30-day window.
- Fenetre historique validee : `2023-03-25` -> `2026-05-23`, `1156` jours.
- V7.1 etend uniquement l'ingestion de trades publics historiques Binance `aggTrades` en lecture seule.
- Fenetre trades : `2023-03-25` -> `2023-04-23`.
- V7.1 ne produit aucune feature, aucun label, aucun dataset ML et aucun modele ML.
...
- V7.1 reste `pending_external_audit` et n'est pas validee avant audit externe.

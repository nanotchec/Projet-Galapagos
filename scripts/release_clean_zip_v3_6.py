...
VERSION = "V3.6"
ZIP_NAME = "projet-galapagos-v3.6-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_6.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_6.md")
...
V3_6_BASE = "data/research/v3_6/features/ohlcv/source=binance_archive/market_type=spot/symbol=BTCUSDT"
...
for timeframe in TIMEFRAMES:
    ...
    INCLUDED_PATHS.append(f"{V3_6_BASE}/timeframe={timeframe}/window=2024-01-01_2024-03-30/features.parquet")
...
def main() -> None:
    ...
    payload = {
        ...
        "contains_v3_5_ohlcv_inputs": True,
        "contains_v3_6_feature_outputs": True,
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe feature store causal 90 jours V3.6.\n",
        encoding="utf-8",
    )

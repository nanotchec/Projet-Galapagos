...
ZIP_NAME = "projet-galapagos-v2.4.5-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_4_5.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_4_5.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_4_5.py",
    "scripts/audit_clean_zip_v2_4_5.py",
    "scripts/smoke_test_clean_zip_v2_4_5.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la validation stricte de schéma silver et finalisation de temps d'exécution V2.4.5.\n",
        encoding="utf-8",
    )

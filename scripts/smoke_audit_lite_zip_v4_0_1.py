...
VERSION = "V4.0.1"
REPORT_JSON = Path("reports/audit_lite/zip_smoke_v4_0_1.json")
REPORT_MD = Path("reports/audit_lite/zip_smoke_v4_0_1.md")
...
def smoke_zip(zip_path: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos-v4-0-1-smoke-") as tmp:
...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    return f"""# Smoke ZIP audit-lite V4.0.1

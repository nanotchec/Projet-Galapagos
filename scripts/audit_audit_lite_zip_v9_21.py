...
REQUIRED_FILES = [
    ...
    "scripts/run_aggtrades_post_v9_batch_expansion_v9_21.py",
    "scripts/validate_aggtrades_post_v9_batch_expansion_v9_21.py",
    "scripts/release_audit_lite_zip_v9_21.py",
    "scripts/audit_audit_lite_zip_v9_21.py",
    "scripts/smoke_audit_lite_zip_v9_21.py",
    "src/galapagos/data/aggtrades_post_v9_collection_v9_18.py",
    "src/galapagos/data/aggtrades_post_v9_batch_expansion_v9_21.py",
    "src/galapagos/data/aggtrades_post_v9_batch_expansion_v9_21_validation.py",
    ...
    "reports/data/aggtrades_post_v9_batch_expansion_v9_21.md",
    "docs/aggtrades_post_v9_batch_expansion_v9_21.md",
    "reports/audit_lite/v9_21_command_results.json",
    "reports/audit_lite/v9_21_command_results.md",
    "reports/audit_lite/v9_21_full_local_validation_attestation.json",
    "reports/audit_lite/v9_21_full_local_validation_attestation.md",
    "reports/audit_lite/v9_21_artifact_inventory.json",
    "reports/audit_lite/v9_21_artifact_inventory.md",
    "reports/audit_lite/zip_size_report_v9_21.json",
    "reports/audit_lite/zip_size_report_v9_21.md",
    "reports/audit_lite/zip_audit_v9_21.json",
    "reports/audit_lite/zip_audit_v9_21.md",
    "reports/audit_lite/zip_smoke_v9_21.json",
    "reports/audit_lite/zip_smoke_v9_21.md",
...
def audit_zip(zip_path: Path) -> list[str]:
    ...
    errors: list[str] = []
    with tempfile.TemporaryDirectory(prefix="galapagos_v9_21_audit_") as tmp:
...
def _check_inventory(extract_root: Path, names: list[str]) -> list[str]:
    errors: list[str] = []
    inventory = _read_json(extract_root / "reports/audit_lite/v9_21_artifact_inventory.json")
    size_report = _read_json(extract_root / "reports/audit_lite/zip_size_report_v9_21.json")
...
def _check_reports(extract_root: Path) -> list[str]:
    ...
    manifest = _read_json(extract_root / "reports/manifests/aggtrades_post_v9_batch_expansion_v9_21_manifest.json")
    attestation = _read_json(extract_root / "reports/audit_lite/v9_21_full_local_validation_attestation.json")
    if report.get("mode") != "collect":
        errors.append("V9.21 audit-lite must describe the collect batch")
...
def _check_command_results(extract_root: Path) -> list[str]:
    errors: list[str] = []
    payload = _read_json(extract_root / "reports/audit_lite/v9_21_command_results.json")
    ...
    required_needles = [
        ...
        "test_aggtrades_post_v9_batch_expansion_v9_21.py",
        "test_aggtrades_post_v9_batch_expansion_v9_21_validator.py",
        "run_aggtrades_post_v9_batch_expansion_v9_21.py --mode collect --start-date 2024-06-11 --end-date 2024-08-09 --max-downloads 60",
        "validate_aggtrades_post_v9_batch_expansion_v9_21.py",
        "release_audit_lite_zip_v9_21.py",
    ]
...
def _check_state(extract_root: Path) -> list[str]:
    ...
    for name, payload in {"PROJECT_STATE": state, "latest_metrics": metrics}.items():
        if payload.get("last_validated_version") != "V9.20":
        ...
        if payload.get("direction") != "aggtrades_post_v9_batch_expansion":
...
def _write_reports(result: dict[str, Any]) -> None:
    ...
    (report_dir / "zip_audit_v9_21.json").write_text(json.dumps(result, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    (report_dir / "zip_audit_v9_21.md").write_text(
        "# Audit ZIP V9.21\n\n"

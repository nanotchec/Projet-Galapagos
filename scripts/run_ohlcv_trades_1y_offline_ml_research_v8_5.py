...
from galapagos.ml.ohlcv_trades_1y_window import run_ohlcv_trades_1y_offline_ml_research_v8_5


def main() -> None:
    manifest = run_ohlcv_trades_1y_offline_ml_research_v8_5(Path("."))
    summary = {

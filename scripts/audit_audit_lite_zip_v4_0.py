...
VERSION = "V4.0"
REPORT_JSON = Path("reports/audit_lite/zip_audit_v4_0.json")
REPORT_MD = Path("reports/audit_lite/zip_audit_v4_0.md")
REQUIRED_FILES = {
    "README.md",
    "pyproject.toml",
...
def audit_zip(zip_path: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos-v4-0-audit-") as tmp:
...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    return f"""# Audit ZIP audit-lite V4.0

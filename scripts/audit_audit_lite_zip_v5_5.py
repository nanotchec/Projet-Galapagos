...
VERSION = "V5.5"
REPORT_JSON = Path("reports/audit_lite/zip_audit_v5_5.json")
REPORT_MD = Path("reports/audit_lite/zip_audit_v5_5.md")
REQUIRED_FILES = {
    "README.md",
    "pyproject.toml",
    ...
    "reports/audit_lite/v5_5_artifact_inventory.json",
    "reports/audit_lite/v5_5_artifact_inventory.md",
    "reports/audit_lite/zip_size_report_v5_5.json",
    "reports/audit_lite/zip_size_report_v5_5.md",
    "reports/audit_lite/v5_5_full_local_validation_attestation.json",
    "reports/audit_lite/v5_5_full_local_validation_attestation.md",
    "reports/PROJECT_STATE.json",
    "reports/current/latest_summary.md",
    "docs/max_history_ml_robustness_v5_5.md",
    "scripts/run_max_history_ml_robustness_v5_5.py",
    "scripts/validate_max_history_ml_robustness_v5_5.py",
    "scripts/release_audit_lite_zip_v5_5.py",
    "scripts/audit_audit_lite_zip_v5_5.py",
    "scripts/smoke_audit_lite_zip_v5_5.py",
    "tests/ml/test_max_history_ml_robustness_v5_5.py",
    "tests/validation/test_max_history_ml_robustness_v5_5_validator.py",
}
...
def audit_zip(zip_path: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos-v5-5-audit-") as tmp:
        ...
        if manifest != report:
            errors.append("V5.5 manifest/report mismatch in ZIP")
        if manifest.get("version") != VERSION:
            errors.append("V5.5 manifest version mismatch in ZIP")
...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    return f"""# Audit ZIP audit-lite V5.5

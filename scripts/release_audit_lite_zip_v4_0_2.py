...
VERSION = "V4.0.2"
ZIP_NAME = "projet-galapagos-v4.0.2-audit-lite.zip"
...
def main() -> None:
    ...
    _write_text(root / ZIP_SIZE_MD, "# Rapport de taille ZIP audit-lite V4.0.2\n\n- Note : `audit-lite does not replace full local validation`\n")
    ...
    payload = {
        "version": VERSION,
        "correction_scope": "audit-lite Python cache exclusion fix",
        "status": "PASS",
...
def _render_inventory_markdown(inventory: dict[str, Any]) -> str:
    ...
    return f"""# Inventaire audit-lite V4.0.2

...
VERSION = "V4.7"
REPORT_JSON = Path("reports/audit_lite/zip_audit_v4_7.json")
REPORT_MD = Path("reports/audit_lite/zip_audit_v4_7.md")
REQUIRED_FILES = {
    "README.md",
    "pyproject.toml",
    ...
    "reports/audit_lite/v4_7_artifact_inventory.json",
    "reports/audit_lite/v4_7_artifact_inventory.md",
    "reports/audit_lite/zip_size_report_v4_7.json",
    "reports/audit_lite/zip_size_report_v4_7.md",
    "reports/audit_lite/v4_7_full_local_validation_attestation.json",
    "reports/audit_lite/v4_7_full_local_validation_attestation.md",
...
def audit_zip(zip_path: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos-v4-7-audit-") as tmp:
        ...
        if manifest != report:
            errors.append("V4.7 manifest/report mismatch in ZIP")
        if manifest.get("version") != VERSION:
            errors.append("V4.7 manifest version mismatch in ZIP")
...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    return f"""# Audit ZIP audit-lite V4.7

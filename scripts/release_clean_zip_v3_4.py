...
ZIP_NAME = "projet-galapagos-v3.4-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_4.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_4.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe robustesse et falsification ML offline multi-day V3.4.\n",
        encoding="utf-8",
    )

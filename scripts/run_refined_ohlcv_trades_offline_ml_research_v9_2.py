...
from galapagos.ml.refined_ohlcv_trades_window import run_refined_ohlcv_trades_offline_ml_research_v9_2


def main() -> int:
    manifest = run_refined_ohlcv_trades_offline_ml_research_v9_2()
    print(
        json.dumps(
            {

...
from release_clean_zip_v3_5_2 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS
...
ESSENTIAL_ENTRIES = [
    ...
    "scripts/smoke_test_clean_zip_v3_5.py",
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_5_2.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_5_2.md").write_text(
        "# Audit ZIP V3.5.2\n\n"

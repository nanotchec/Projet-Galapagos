...
VERSION = "V4.0.2"
REPORT_JSON = Path("reports/audit_lite/zip_audit_v4_0_2.json")
REPORT_MD = Path("reports/audit_lite/zip_audit_v4_0_2.md")
REQUIRED_FILES = {
    "README.md",
    "pyproject.toml",
    ...
    "reports/audit_lite/v4_0_artifact_inventory.json",
    "reports/audit_lite/v4_0_full_local_validation_attestation.json",
    "reports/audit_lite/v4_0_full_local_validation_attestation.md",
    ...
    "scripts/release_audit_lite_zip_v4_0_1.py",
    "scripts/audit_audit_lite_zip_v4_0_1.py",
    "scripts/smoke_audit_lite_zip_v4_0_1.py",
    "scripts/release_audit_lite_zip_v4_0_2.py",
    "scripts/audit_audit_lite_zip_v4_0_2.py",
    "scripts/smoke_audit_lite_zip_v4_0_2.py",
...
def audit_zip(zip_path: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos-v4-0-2-audit-") as tmp:
        ...
        if manifest != report:
            errors.append("V4.0 manifest/report mismatch in ZIP")
        if manifest.get("version") != "V4.0":
            errors.append("V4.0 manifest version mismatch in ZIP")
...
def _render_markdown(result: dict[str, Any]) -> str:
    ...
    return f"""# Audit ZIP audit-lite V4.0.2

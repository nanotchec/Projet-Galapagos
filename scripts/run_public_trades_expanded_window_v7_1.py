...
from galapagos.data.public_trades.expanded_window import (
    discover_public_trades_expanded_window_v7_1,
    run_public_trades_expanded_window_v7_1,
)
...
def main() -> None:
    ...
    if (
        args.start_date != DEFAULT_EXPANDED_WINDOW_START_V7_1
        or args.end_date != DEFAULT_EXPANDED_WINDOW_END_V7_1
    ...
    manifest = run_public_trades_expanded_window_v7_1(
        Path("."),
        no_network=args.no_network,
        force=args.force,

...
ZIP_NAME = "projet-galapagos-v2.7-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_7.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_7.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_7.py",
    "scripts/audit_clean_zip_v2_7.py",
    "scripts/smoke_test_clean_zip_v2_7.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du dataset supervise offline V2.7.\n",
        encoding="utf-8",
    )

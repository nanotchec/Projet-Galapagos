...
ZIP_NAME = "projet-galapagos-v2.6-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_6.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_6.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_6.py",
    "scripts/audit_clean_zip_v2_6.py",
    "scripts/smoke_test_clean_zip_v2_6.py",

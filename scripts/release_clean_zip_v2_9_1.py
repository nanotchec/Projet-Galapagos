...
ZIP_NAME = "projet-galapagos-v2.9.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_9_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_9_1.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview multi-day data-only V2.9.\n",
        encoding="utf-8",
    )

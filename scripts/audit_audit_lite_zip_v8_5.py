...
VERSION = "V8.5"
AUDIT_JSON = Path("reports/audit_lite/zip_audit_v8_5.json")
AUDIT_MD = Path("reports/audit_lite/zip_audit_v8_5.md")
...
REQUIRED_ENTRIES = {
    ...
    "reports/ml/ohlcv_trades_1y_offline_ml_research_v8_5.md",
    "reports/ml/ohlcv_trades_1y_offline_research_scores_v8_5.json",
    "reports/ml/ohlcv_trades_1y_offline_research_scores_v8_5.md",
    "reports/audit_lite/v8_5_full_local_validation_attestation.json",
    "reports/audit_lite/v8_5_full_local_validation_attestation.md",
    "reports/audit_lite/v8_5_artifact_inventory.json",
    "reports/audit_lite/v8_5_artifact_inventory.md",
    "reports/audit_lite/v8_5_parquet_summary.json",
    "reports/audit_lite/zip_size_report_v8_5.json",
    "reports/audit_lite/zip_size_report_v8_5.md",
    "docs/ohlcv_trades_1y_offline_ml_research_v8_5.md",
    "scripts/run_ohlcv_trades_1y_offline_ml_research_v8_5.py",
    "scripts/validate_ohlcv_trades_1y_offline_ml_research_v8_5.py",
    "scripts/release_audit_lite_zip_v8_5.py",
    "scripts/audit_audit_lite_zip_v8_5.py",
    "scripts/smoke_audit_lite_zip_v8_5.py",
    "tests/ml/test_ohlcv_trades_1y_offline_ml_research_v8_5.py",
    "tests/validation/test_ohlcv_trades_1y_offline_ml_research_v8_5_validator.py",
...
SAMPLE_ENTRIES = {
    "data/audit_lite/v8_5/ml_scores/timeframe=1m/sample.parquet",
    "data/audit_lite/v8_5/ml_scores/timeframe=5m/sample.parquet",
    "data/audit_lite/v8_5/ml_scores/timeframe=15m/sample.parquet",
    "data/audit_lite/v8_5/ml_scores/timeframe=1h/sample.parquet",
}
FORBIDDEN_PREFIXES = (
    "data/raw/",
    "data/research/",

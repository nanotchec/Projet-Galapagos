...
VERSION = "V3.5.1"
ZIP_NAME = "projet-galapagos-v3.5.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_5_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_5_1.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe expansion data publique 90 jours V3.5.1.\n",
        encoding="utf-8",
    )

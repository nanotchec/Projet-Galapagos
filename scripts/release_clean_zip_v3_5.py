...
VERSION = "V3.5"
ZIP_NAME = "projet-galapagos-v3.5-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_5.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_5.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe expansion data publique 90 jours V3.5.\n",
        encoding="utf-8",
    )

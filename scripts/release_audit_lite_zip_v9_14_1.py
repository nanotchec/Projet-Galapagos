...
REPORT_PATHS = [
    ...
    Path("reports/research_decisions/feature_label_separability_v9_14_1.md"),
    Path("docs/feature_label_separability_v9_14_1.md"),
]

AUDIT_PATHS = [
    Path("reports/audit_lite/v9_14_1_command_results.json"),
    Path("reports/audit_lite/v9_14_1_command_results.md"),
    Path("reports/audit_lite/v9_14_1_full_local_validation_attestation.json"),
    Path("reports/audit_lite/v9_14_1_full_local_validation_attestation.md"),
    Path("reports/audit_lite/v9_14_1_artifact_inventory.json"),
    Path("reports/audit_lite/v9_14_1_artifact_inventory.md"),
    Path("reports/audit_lite/zip_size_report_v9_14_1.json"),
    Path("reports/audit_lite/zip_size_report_v9_14_1.md"),
    Path("reports/audit_lite/zip_audit_v9_14_1.json"),
    Path("reports/audit_lite/zip_audit_v9_14_1.md"),
    Path("reports/audit_lite/zip_smoke_v9_14_1.json"),
    Path("reports/audit_lite/zip_smoke_v9_14_1.md"),
]
...
SCRIPT_PATHS = [
    ...
    Path("scripts/run_feature_label_separability_v9_14_1.py"),
    Path("scripts/validate_feature_label_separability_v9_14_1.py"),
    Path("scripts/release_audit_lite_zip_v9_14_1.py"),
    Path("scripts/audit_audit_lite_zip_v9_14_1.py"),
    Path("scripts/smoke_audit_lite_zip_v9_14_1.py"),
]

TEST_PATHS = [
    Path("tests/research/test_feature_label_separability_v9_14_1.py"),
    Path("tests/validation/test_feature_label_separability_v9_14_1_validator.py"),
]

CODE_PATHS = [
    Path("src/galapagos/__init__.py"),
    Path("src/galapagos/research/feature_label_separability_v9_14_1.py"),
    Path("src/galapagos/research/feature_label_separability_v9_14_1_validation.py"),
]
...
def main() -> int:
    _ensure_inputs()
    report = _read_json(Path("reports/research_decisions/feature_label_separability_v9_14_1.json"))
...
def _ensure_inputs() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"missing V9.14.1 audit-lite inputs: {missing}")


def _ensure_placeholders() -> None:
    placeholders = {
        "reports/audit_lite/v9_14_1_command_results.json": {"version": VERSION, "status": "PENDING_CAPTURE", "commands": [], "sidecars_created": False, "zip_fingerprints_created": False},
        "reports/audit_lite/zip_audit_v9_14_1.json": {"version": VERSION, "passed": False, "errors": [], "status": "PENDING_RUN"},
        "reports/audit_lite/zip_smoke_v9_14_1.json": {"version": VERSION, "passed": False, "errors": [], "status": "PENDING_RUN"},
    }
    ...
    for raw_path, text in {
        "reports/audit_lite/v9_14_1_command_results.md": "# Commandes V9.14.1\n\nRapport en attente de capture finale.\n",
        "reports/audit_lite/zip_audit_v9_14_1.md": "# Audit ZIP V9.14.1\n\nRapport en attente d'execution.\n",
        "reports/audit_lite/zip_smoke_v9_14_1.md": "# Smoke ZIP V9.14.1\n\nRapport en attente d'execution.\n",
    }.items():
        path = Path(raw_path)
        if not (ROOT / path).exists():
...
def _write_attestation(report: dict[str, Any], zip_bytes: int | None) -> None:
    command_results = _read_optional_json(Path("reports/audit_lite/v9_14_1_command_results.json"))
    ...
    payload = {
        ...
        "validator_passed": _commands_passed(commands, ["validate_feature_label_separability_v9_14_1.py"]),
        "audit_lite_passed": _commands_passed(commands, ["audit_audit_lite_zip_v9_14_1.py"]),
        "smoke_audit_lite_passed": _commands_passed(commands, ["smoke_audit_lite_zip_v9_14_1.py"]),
        "previous_v9_14_decision": report["previous_v9_14_decision"],
        "corrected_decision": report["corrected_decision"],
        **report["safety_flags"],
    }
    _write_json(Path("reports/audit_lite/v9_14_1_full_local_validation_attestation.json"), payload)
    _write_text(
        Path("reports/audit_lite/v9_14_1_full_local_validation_attestation.md"),
        "# Attestation full locale V9.14.1\n\n"
        f"- Decision corrigee : `{report['corrected_decision']}`.\n"
        "- Correction limitee a l'inventaire data-extension et a la decision de branche.\n"
...
def _write_size_report(paths: list[Path], zip_bytes: int | None) -> None:
    ...
    _write_json(Path("reports/audit_lite/zip_size_report_v9_14_1.json"), payload)
    _write_text(Path("reports/audit_lite/zip_size_report_v9_14_1.md"), f"# Taille ZIP V9.14.1\n\n- ZIP : `{ZIP_NAME}`.\n- Taille bytes : `{zip_bytes}`.\n- Fichiers inclus : `{len(paths)}`.\n")

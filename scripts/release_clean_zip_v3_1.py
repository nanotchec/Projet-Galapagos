...
ZIP_NAME = "projet-galapagos-v3.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_1.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview label factory forward multi-day V3.1.\n",
        encoding="utf-8",
    )

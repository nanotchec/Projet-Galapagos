...
ZIP_NAME = "projet-galapagos-v2.4-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_4.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_4.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_4.py",
    "scripts/audit_clean_zip_v2_4.py",
    "scripts/smoke_test_clean_zip_v2_4.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du resampling OHLCV data-only.\n",
        encoding="utf-8",
    )

...
from release_clean_zip_v3_2 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS
...
ESSENTIAL_ENTRIES = [
    "scripts/run_multi_day_offline_supervised_dataset_v3_2.py",
    "scripts/validate_multi_day_offline_supervised_dataset_v3_2.py",
    "scripts/smoke_test_clean_zip_v3_2_1.py",
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_2_1.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_2_1.md").write_text(
        "# Audit ZIP V3.2.1\n\n"

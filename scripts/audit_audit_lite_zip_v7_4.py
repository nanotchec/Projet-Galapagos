...
VERSION = "V7.4"
AUDIT_JSON = Path("reports/audit_lite/zip_audit_v7_4.json")
AUDIT_MD = Path("reports/audit_lite/zip_audit_v7_4.md")
...
REQUIRED_ENTRIES = {
    ...
    "reports/ml/ohlcv_trades_offline_ml_research_v7_4.md",
    "reports/ml/ohlcv_trades_offline_research_scores_v7_4.json",
    "reports/ml/ohlcv_trades_offline_research_scores_v7_4.md",
    "reports/audit_lite/v7_4_full_local_validation_attestation.json",
    "reports/audit_lite/v7_4_full_local_validation_attestation.md",
    "reports/audit_lite/v7_4_artifact_inventory.json",
    "reports/audit_lite/v7_4_parquet_summary.json",
    "docs/ohlcv_trades_offline_ml_research_v7_4.md",
    "scripts/run_ohlcv_trades_offline_ml_research_v7_4.py",
    "scripts/validate_ohlcv_trades_offline_ml_research_v7_4.py",
    "scripts/release_audit_lite_zip_v7_4.py",
    "scripts/audit_audit_lite_zip_v7_4.py",
    "scripts/smoke_audit_lite_zip_v7_4.py",
    "tests/ml/test_ohlcv_trades_offline_ml_research_v7_4.py",
    "tests/validation/test_ohlcv_trades_offline_ml_research_v7_4_validator.py",
...
SAMPLE_ENTRIES = {
    "data/audit_lite/v7_4/ml_scores/timeframe=1m/sample.parquet",
    "data/audit_lite/v7_4/ml_scores/timeframe=5m/sample.parquet",
    "data/audit_lite/v7_4/ml_scores/timeframe=15m/sample.parquet",
    "data/audit_lite/v7_4/ml_scores/timeframe=1h/sample.parquet",
}
FORBIDDEN_PREFIXES = (
    "data/raw/",
    "data/research/",

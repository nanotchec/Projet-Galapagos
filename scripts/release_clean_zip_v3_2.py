...
ZIP_NAME = "projet-galapagos-v3.2-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_2.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_2.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview dataset supervise offline multi-day V3.2.\n",
        encoding="utf-8",
    )

...
ZIP_NAME = "projet-galapagos-v2.4.7-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_4_7.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_4_7.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du smoke test dynamique et finalisation du validateur V2.4.7.\n",
        encoding="utf-8",
    )

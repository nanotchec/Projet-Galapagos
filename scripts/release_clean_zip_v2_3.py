...
ZIP_NAME = "projet-galapagos-v2.3-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_3.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_3.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_3.py",
    "scripts/audit_clean_zip_v2_3.py",
    "scripts/smoke_test_clean_zip_v2_3.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview ingestion publique read-only.\n",
        encoding="utf-8",
    )

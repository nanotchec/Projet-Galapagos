...
REQUIRED_FILES = [
    ...
    "src/galapagos/features/ohlcv_aggtrades_exact_5y_feature_store_v9_47_validation.py",
    "scripts/run_ohlcv_aggtrades_exact_5y_feature_store_v9_47.py",
    "scripts/validate_ohlcv_aggtrades_exact_5y_feature_store_v9_47.py",
    "scripts/release_audit_lite_zip_v9_47.py",
    "scripts/audit_audit_lite_zip_v9_47.py",
    "scripts/smoke_audit_lite_zip_v9_47.py",
    "tests/features/test_ohlcv_aggtrades_exact_5y_feature_store_v9_47.py",
    "tests/validation/test_ohlcv_aggtrades_exact_5y_feature_store_v9_47_validator.py",
    "reports/manifests/ohlcv_aggtrades_exact_5y_feature_store_v9_47_manifest.json",
    "reports/features/ohlcv_aggtrades_exact_5y_feature_store_v9_47.json",
    "reports/features/ohlcv_aggtrades_exact_5y_feature_store_v9_47.md",
    "docs/ohlcv_aggtrades_exact_5y_feature_store_v9_47.md",
    "reports/audit_lite/v9_47_command_results.json",
    "reports/audit_lite/v9_47_command_results.md",
    "reports/audit_lite/v9_47_full_local_validation_attestation.json",
    "reports/audit_lite/v9_47_full_local_validation_attestation.md",
    "reports/audit_lite/v9_47_artifact_inventory.json",
    "reports/audit_lite/v9_47_artifact_inventory.md",
    "reports/audit_lite/zip_size_report_v9_47.json",
    "reports/audit_lite/zip_size_report_v9_47.md",
    "reports/audit_lite/zip_audit_v9_47.json",
    "reports/audit_lite/zip_audit_v9_47.md",
    "reports/audit_lite/zip_smoke_v9_47.json",
    "reports/audit_lite/zip_smoke_v9_47.md",
]
...
def audit_zip(zip_path: Path) -> list[str]:
    ...
    errors: list[str] = []
    with tempfile.TemporaryDirectory(prefix="galapagos_v9_47_audit_") as tmp:
...
def _check_inventory(extract_root: Path, names: list[str]) -> list[str]:
    errors: list[str] = []
    inventory = _read_json(extract_root / "reports/audit_lite/v9_47_artifact_inventory.json")
    size_report = _read_json(extract_root / "reports/audit_lite/zip_size_report_v9_47.json")
...
def _check_reports(extract_root: Path) -> list[str]:
    errors: list[str] = []
    report = _read_json(extract_root / "reports/features/ohlcv_aggtrades_exact_5y_feature_store_v9_47.json")
    manifest = _read_json(extract_root / "reports/manifests/ohlcv_aggtrades_exact_5y_feature_store_v9_47_manifest.json")
    attestation = _read_json(extract_root / "reports/audit_lite/v9_47_full_local_validation_attestation.json")
    ...
    for key in ["dataset_created", "labels_created", "ml_executed", "walk_forward_executed", "backtest_executed", "network_used", "new_data_downloaded", "signal_created", "strategy_created"]:
    ...
    if manifest.get("decision") != report.get("decision") or manifest.get("safety_flags") != report.get("safety_flags"):
        errors.append("V9.47 manifest mismatch")
...
def _check_command_results(extract_root: Path) -> list[str]:
    payload = _read_json(extract_root / "reports/audit_lite/v9_47_command_results.json")
    ...
    for needle in ["pytest --collect-only -q", "test_ohlcv_aggtrades_exact_5y_feature_store_v9_47.py", "test_ohlcv_aggtrades_exact_5y_feature_store_v9_47_validator.py", "run_ohlcv_aggtrades_exact_5y_feature_store_v9_47.py", "validate_ohlcv_aggtrades_exact_5y_feature_store_v9_47.py", "release_audit_lite_zip_v9_47.py"]:
...
def _write_reports(result: dict[str, Any]) -> None:
    ...
    (report_dir / "zip_audit_v9_47.json").write_text(json.dumps(result, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    (report_dir / "zip_audit_v9_47.md").write_text("# Audit ZIP V9.47\n\n" f"- Resultat : `{'PASS' if result['passed'] else 'FAIL'}`.\n" f"- Erreurs : `{result['errors']}`.\n" "- Aucun sidecar et aucune empreinte ZIP.\n", encoding="utf-8")

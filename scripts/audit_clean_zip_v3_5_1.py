...
from release_clean_zip_v3_5_1 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_5_1.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_5_1.md").write_text(
        "# Audit ZIP V3.5.1\n\n"

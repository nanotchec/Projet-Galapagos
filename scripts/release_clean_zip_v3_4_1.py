...
ZIP_NAME = "projet-galapagos-v3.4.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_4_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_4_1.md")
...
def main() -> None:
    ...
    payload = {
        ...
        "contains_robustness_audit": True,
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe robustesse et falsification ML offline multi-day V3.4.1.\n",
        encoding="utf-8",
    )

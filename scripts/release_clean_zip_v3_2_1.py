...
ZIP_NAME = "projet-galapagos-v3.2.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_2_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_2_1.md")
...
for tf in TIMEFRAMES:
    INCLUDED_PATHS.extend(
        [
            ...
            f"{V3_2_BASE}/timeframe={tf}/window=2024-01-15_2024-01-21/dataset.parquet",
            f"{V3_2_BASE}/timeframe={tf}/window=2024-01-15_2024-01-21/splits.parquet",
        ]
    )
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview dataset supervise offline multi-day V3.2.1.\n",
        encoding="utf-8",
    )

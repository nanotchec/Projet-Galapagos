...
from release_clean_zip_v3_1_4 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_1_4.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_1_4.md").write_text(
        "# Audit ZIP V3.1.4\n\n"

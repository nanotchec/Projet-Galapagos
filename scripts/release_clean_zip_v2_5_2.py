...
ZIP_NAME = "projet-galapagos-v2.5.2-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_5_2.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_5_2.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_5_2.py",
    "scripts/audit_clean_zip_v2_5_2.py",
    "scripts/smoke_test_clean_zip_v2_5_2.py",

...
from release_clean_zip_v3_3 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS
...
ESSENTIAL_ENTRIES = [
    ...
    "scripts/smoke_test_clean_zip_v3_3.py",
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_3.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_3.md").write_text(
        "# Audit ZIP V3.3\n\n"

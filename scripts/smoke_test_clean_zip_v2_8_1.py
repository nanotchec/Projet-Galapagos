...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos_v2_8_1_smoke_") as tmp:
        tmp_path = Path(tmp)
        ...
        script_check = (
            ...
            "assert manifest['correction_version']=='V2.8.1'\n"
    ...
    Path("reports/zip_smoke_test_v2_8_1.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_smoke_test_v2_8_1.md").write_text(
        "# Smoke ZIP V2.8.1\n\n"

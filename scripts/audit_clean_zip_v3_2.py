...
ESSENTIAL_ENTRIES = [
    ...
    "scripts/smoke_test_clean_zip_v3_2.py",
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_2.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_2.md").write_text(
        "# Audit ZIP V3.2\n\n"

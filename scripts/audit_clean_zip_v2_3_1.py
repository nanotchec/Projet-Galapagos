...
REQUIRED = [
    "src/galapagos/data/public_market/__init__.py",
    "src/galapagos/validation/market_data.py",
    "scripts/run_public_market_ingestion_preview_v2_3.py",
    "scripts/validate_public_market_ingestion_v2_3.py",
    "scripts/release_clean_zip_v2_3_1.py",
    "scripts/audit_clean_zip_v2_3_1.py",
    "scripts/smoke_test_clean_zip_v2_3_1.py",
...
FORBIDDEN_PARTS = [".git/", ".venv/", "__pycache__/", ".pytest_cache/", ".ruff_cache/", "node_modules/"]
...
def main() -> None:
    ...
    Path("reports/zip_audit_v2_3_1.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v2_3_1.md").write_text(
        "# Audit ZIP V2.3.1\n\n"

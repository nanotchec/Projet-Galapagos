...
from galapagos.ml.advanced_ohlcv_robustness import run_advanced_ohlcv_ml_robustness_v6_3


def main() -> None:
    manifest = run_advanced_ohlcv_ml_robustness_v6_3(Path("."))
    print(
        json.dumps(
            {
                ...
                "findings": {
                    ...
                    "advanced_features_validated_for_trading": manifest["findings"]["advanced_features_validated_for_trading"],
                },
            },
            indent=2,
            ensure_ascii=False,

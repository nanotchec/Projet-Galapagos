...
from release_clean_zip_v2_8_4 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS, RAW_ARCHIVE_ENTRY
...
def main() -> None:
    ...
    Path("reports/zip_audit_v2_8_4.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v2_8_4.md").write_text(
        "# Audit ZIP V2.8.4\n\n"

...
VERSION = "V8.0"
AUDIT_JSON = Path("reports/audit_lite/zip_audit_v8_0.json")
AUDIT_MD = Path("reports/audit_lite/zip_audit_v8_0.md")
...
REQUIRED_ENTRIES = {
    ...
    "reports/ml/ohlcv_trades_90d_offline_ml_research_v8_0.md",
    "reports/ml/ohlcv_trades_90d_offline_research_scores_v8_0.json",
    "reports/ml/ohlcv_trades_90d_offline_research_scores_v8_0.md",
    "reports/ml/ohlcv_trades_90d_ml_robustness_v8_0.json",
    "reports/ml/ohlcv_trades_90d_ml_robustness_v8_0.md",
    "reports/audit_lite/v8_0_full_local_validation_attestation.json",
    "reports/audit_lite/v8_0_full_local_validation_attestation.md",
    "reports/audit_lite/v8_0_artifact_inventory.json",
    "reports/audit_lite/v8_0_parquet_summary.json",
    "docs/ohlcv_trades_90d_offline_ml_research_v8_0.md",
    "docs/ohlcv_trades_90d_ml_robustness_v8_0.md",
    "scripts/run_ohlcv_trades_90d_offline_ml_research_v8_0.py",
    "scripts/validate_ohlcv_trades_90d_offline_ml_research_v8_0.py",
    "scripts/run_ohlcv_trades_90d_ml_robustness_v8_0.py",
    "scripts/validate_ohlcv_trades_90d_ml_robustness_v8_0.py",
...
SAMPLE_ENTRIES = {
    "data/audit_lite/v8_0/ml_scores/timeframe=1m/sample.parquet",
    "data/audit_lite/v8_0/ml_scores/timeframe=5m/sample.parquet",
    "data/audit_lite/v8_0/ml_scores/timeframe=15m/sample.parquet",
    "data/audit_lite/v8_0/ml_scores/timeframe=1h/sample.parquet",
}
FORBIDDEN_PREFIXES = (
    "data/raw/",
    "data/research/",

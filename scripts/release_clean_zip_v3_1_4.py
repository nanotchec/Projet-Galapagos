...
ZIP_NAME = "projet-galapagos-v3.1.4-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_1_4.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_1_4.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v3_1_4.py",
    "scripts/audit_clean_zip_v3_1_4.py",
    "scripts/smoke_test_clean_zip_v3_1_4.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview label factory forward multi-day V3.1.4.\n",
        encoding="utf-8",
    )

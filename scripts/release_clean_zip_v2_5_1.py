...
ZIP_NAME = "projet-galapagos-v2.5.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_5_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_5_1.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_5_1.py",
    "scripts/audit_clean_zip_v2_5_1.py",
    "scripts/smoke_test_clean_zip_v2_5_1.py",
...
def main() -> None:
    ...
    payload = {
        ...
        "contains_features_validator": True,
        "contains_tests": True,
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du Feature Store V2.5.1.\n",
        encoding="utf-8",
    )

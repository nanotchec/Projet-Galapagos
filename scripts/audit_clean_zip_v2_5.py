...
REQUIRED = [
    ...
    "scripts/release_clean_zip_v2_5.py",
    "scripts/audit_clean_zip_v2_5.py",
    "scripts/smoke_test_clean_zip_v2_5.py",
...
def main() -> None:
    ...
    Path("reports/zip_audit_v2_5.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v2_5.md").write_text(
        "# Audit ZIP V2.5\n\n"

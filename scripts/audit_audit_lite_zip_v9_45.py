...
REQUIRED_FILES = [
    ...
    "src/galapagos/features/aggtrades_exact_5y_feature_enrichment_v9_45_validation.py",
    "src/galapagos/features/aggtrades_exact_5y_feature_enrichment_v9_45_schemas.py",
    "scripts/run_aggtrades_exact_5y_feature_enrichment_v9_45.py",
    "scripts/validate_aggtrades_exact_5y_feature_enrichment_v9_45.py",
    "scripts/release_audit_lite_zip_v9_45.py",
    "scripts/audit_audit_lite_zip_v9_45.py",
    "scripts/smoke_audit_lite_zip_v9_45.py",
    "tests/features/test_aggtrades_exact_5y_feature_enrichment_v9_45.py",
    "tests/validation/test_aggtrades_exact_5y_feature_enrichment_v9_45_validator.py",
    "reports/manifests/aggtrades_exact_5y_feature_enrichment_v9_45_manifest.json",
    "reports/features/aggtrades_exact_5y_feature_enrichment_v9_45.json",
    "reports/features/aggtrades_exact_5y_feature_enrichment_v9_45.md",
    "docs/aggtrades_exact_5y_feature_enrichment_v9_45.md",
    "reports/audit_lite/v9_45_command_results.json",
    "reports/audit_lite/v9_45_command_results.md",
    "reports/audit_lite/v9_45_full_local_validation_attestation.json",
    "reports/audit_lite/v9_45_full_local_validation_attestation.md",
    "reports/audit_lite/v9_45_artifact_inventory.json",
    "reports/audit_lite/v9_45_artifact_inventory.md",
    "reports/audit_lite/zip_size_report_v9_45.json",
    "reports/audit_lite/zip_size_report_v9_45.md",
    "reports/audit_lite/zip_audit_v9_45.json",
    "reports/audit_lite/zip_audit_v9_45.md",
    "reports/audit_lite/zip_smoke_v9_45.json",
    "reports/audit_lite/zip_smoke_v9_45.md",
]
...
def audit_zip(zip_path: Path) -> list[str]:
    ...
    errors: list[str] = []
    with tempfile.TemporaryDirectory(prefix="galapagos_v9_45_audit_") as tmp:
...
def _check_inventory(extract_root: Path, names: list[str]) -> list[str]:
    errors: list[str] = []
    inventory = _read_json(extract_root / "reports/audit_lite/v9_45_artifact_inventory.json")
    size_report = _read_json(extract_root / "reports/audit_lite/zip_size_report_v9_45.json")
...
def _check_reports(extract_root: Path) -> list[str]:
    errors: list[str] = []
    report = _read_json(extract_root / "reports/features/aggtrades_exact_5y_feature_enrichment_v9_45.json")
    manifest = _read_json(extract_root / "reports/manifests/aggtrades_exact_5y_feature_enrichment_v9_45_manifest.json")
    attestation = _read_json(extract_root / "reports/audit_lite/v9_45_full_local_validation_attestation.json")
    ...
    if manifest.get("decision") != report.get("decision") or manifest.get("safety_flags") != report.get("safety_flags"):
        errors.append("V9.45 manifest mismatch")
...
def _check_command_results(extract_root: Path) -> list[str]:
    payload = _read_json(extract_root / "reports/audit_lite/v9_45_command_results.json")
    ...
    for needle in ["pytest --collect-only -q", "test_aggtrades_exact_5y_feature_enrichment_v9_45.py", "test_aggtrades_exact_5y_feature_enrichment_v9_45_validator.py", "run_aggtrades_exact_5y_feature_enrichment_v9_45.py", "validate_aggtrades_exact_5y_feature_enrichment_v9_45.py", "release_audit_lite_zip_v9_45.py"]:
...
def _write_reports(result: dict[str, Any]) -> None:
    ...
    (report_dir / "zip_audit_v9_45.json").write_text(json.dumps(result, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    (report_dir / "zip_audit_v9_45.md").write_text("# Audit ZIP V9.45\n\n" f"- Resultat : `{'PASS' if result['passed'] else 'FAIL'}`.\n" f"- Erreurs : `{result['errors']}`.\n" "- Aucun sidecar et aucune empreinte ZIP.\n", encoding="utf-8")

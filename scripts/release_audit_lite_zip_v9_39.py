...
CORE_PATHS = [
    ...
    Path("src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_39.py"),
    Path("src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_39_validation.py"),
    Path("src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_39_schemas.py"),
    Path("src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_39_datacard.py"),
    Path("scripts/run_ohlcv_aggtrades_5y_dataset_v9_39.py"),
    Path("scripts/validate_ohlcv_aggtrades_5y_dataset_v9_39.py"),
    Path("scripts/release_audit_lite_zip_v9_39.py"),
    Path("scripts/audit_audit_lite_zip_v9_39.py"),
    Path("scripts/smoke_audit_lite_zip_v9_39.py"),
    Path("tests/datasets/test_ohlcv_aggtrades_5y_dataset_v9_39.py"),
    Path("tests/validation/test_ohlcv_aggtrades_5y_dataset_v9_39_validator.py"),
    ...
    Path("reports/datasets/ohlcv_aggtrades_5y_dataset_v9_39.md"),
    Path("reports/datasets/ohlcv_aggtrades_5y_dataset_v9_39_datacard.md"),
    Path("docs/ohlcv_aggtrades_5y_dataset_v9_39.md"),
]
...
AUDIT_PATHS = [
    Path("reports/audit_lite/v9_39_command_results.json"),
    Path("reports/audit_lite/v9_39_command_results.md"),
    Path("reports/audit_lite/v9_39_full_local_validation_attestation.json"),
    Path("reports/audit_lite/v9_39_full_local_validation_attestation.md"),
    Path("reports/audit_lite/v9_39_artifact_inventory.json"),
    Path("reports/audit_lite/v9_39_artifact_inventory.md"),
    Path("reports/audit_lite/zip_size_report_v9_39.json"),
    Path("reports/audit_lite/zip_size_report_v9_39.md"),
    Path("reports/audit_lite/zip_audit_v9_39.json"),
    Path("reports/audit_lite/zip_audit_v9_39.md"),
    Path("reports/audit_lite/zip_smoke_v9_39.json"),
    Path("reports/audit_lite/zip_smoke_v9_39.md"),
]
...
def main() -> int:
    report = _read_json(Path("reports/datasets/ohlcv_aggtrades_5y_dataset_v9_39.json"))
...
def _ensure_placeholders() -> None:
    placeholders = {
        "reports/audit_lite/v9_39_command_results.json": {"version": VERSION, "status": "PENDING_CAPTURE", "commands": [], "sidecars_created": False, "zip_fingerprints_created": False},
        "reports/audit_lite/zip_audit_v9_39.json": {"version": VERSION, "passed": False, "errors": [], "status": "PENDING_RUN"},
        "reports/audit_lite/zip_smoke_v9_39.json": {"version": VERSION, "passed": False, "errors": [], "status": "PENDING_RUN"},
    }
    texts = {
        "reports/audit_lite/v9_39_command_results.md": "# Commandes V9.39\n\nEn attente.\n",
        "reports/audit_lite/zip_audit_v9_39.md": "# Audit ZIP V9.39\n\nEn attente.\n",
        "reports/audit_lite/zip_smoke_v9_39.md": "# Smoke ZIP V9.39\n\nEn attente.\n",
    }
...
def _collect_paths() -> list[Path]:
    ...
    if missing_core:
        raise FileNotFoundError(f"missing V9.39 release inputs: {missing_core}")
...
def _write_attestation(report: dict[str, Any], zip_size: int | None) -> None:
    commands = _read_optional_json(Path("reports/audit_lite/v9_39_command_results.json")).get("commands", [])
    payload = {
        "version": VERSION,
...
def _write_inventory(paths: list[Path], zip_size: int | None) -> None:
    ...
    _write_json(Path("reports/audit_lite/v9_39_artifact_inventory.json"), payload)
    _write_text(Path("reports/audit_lite/v9_39_artifact_inventory.md"), "# Inventaire audit-lite V9.39\n\n" f"- Fichiers inclus : `{len(paths)}`.\n" f"- ZIP : `{ZIP_NAME}`.\n")
...
def _write_size_report(paths: list[Path], zip_size: int | None) -> None:
    ...
    _write_json(Path("reports/audit_lite/zip_size_report_v9_39.json"), payload)
    _write_text(Path("reports/audit_lite/zip_size_report_v9_39.md"), "# Taille ZIP V9.39\n\n" f"- Fichiers : `{len(paths)}`.\n" f"- ZIP bytes estimate : `{zip_size}`.\n")

...
REQUIRED_FILES = [
    ...
    "src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_41.py",
    "src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_41_validation.py",
    "src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_41_schemas.py",
    "src/galapagos/datasets/ohlcv_aggtrades_5y_dataset_v9_41_datacard.py",
    "scripts/run_ohlcv_aggtrades_5y_dataset_v9_41.py",
    "scripts/validate_ohlcv_aggtrades_5y_dataset_v9_41.py",
    "scripts/release_audit_lite_zip_v9_41.py",
    "scripts/audit_audit_lite_zip_v9_41.py",
    "scripts/smoke_audit_lite_zip_v9_41.py",
    "tests/datasets/test_ohlcv_aggtrades_5y_dataset_v9_41.py",
    "tests/validation/test_ohlcv_aggtrades_5y_dataset_v9_41_validator.py",
    "reports/manifests/ohlcv_aggtrades_5y_dataset_v9_41_manifest.json",
    "reports/datasets/ohlcv_aggtrades_5y_dataset_v9_41.json",
    "reports/datasets/ohlcv_aggtrades_5y_dataset_v9_41.md",
    "reports/datasets/ohlcv_aggtrades_5y_dataset_v9_41_datacard.md",
    "docs/ohlcv_aggtrades_5y_dataset_v9_41.md",
    "reports/audit_lite/v9_41_command_results.json",
    "reports/audit_lite/v9_41_command_results.md",
    "reports/audit_lite/v9_41_full_local_validation_attestation.json",
    "reports/audit_lite/v9_41_full_local_validation_attestation.md",
    "reports/audit_lite/v9_41_artifact_inventory.json",
    "reports/audit_lite/v9_41_artifact_inventory.md",
    "reports/audit_lite/zip_size_report_v9_41.json",
    "reports/audit_lite/zip_size_report_v9_41.md",
    "reports/audit_lite/zip_audit_v9_41.json",
    "reports/audit_lite/zip_audit_v9_41.md",
    "reports/audit_lite/zip_smoke_v9_41.json",
    "reports/audit_lite/zip_smoke_v9_41.md",
...
def audit_zip(zip_path: Path) -> list[str]:
    ...
    errors: list[str] = []
    with tempfile.TemporaryDirectory(prefix="galapagos_v9_41_audit_") as tmp:
...
def _check_inventory(extract_root: Path, names: list[str]) -> list[str]:
    errors: list[str] = []
    inventory = _read_json(extract_root / "reports/audit_lite/v9_41_artifact_inventory.json")
    size_report = _read_json(extract_root / "reports/audit_lite/zip_size_report_v9_41.json")
...
def _check_reports(extract_root: Path) -> list[str]:
    errors: list[str] = []
    report = _read_json(extract_root / "reports/datasets/ohlcv_aggtrades_5y_dataset_v9_41.json")
    manifest = _read_json(extract_root / "reports/manifests/ohlcv_aggtrades_5y_dataset_v9_41_manifest.json")
    attestation = _read_json(extract_root / "reports/audit_lite/v9_41_full_local_validation_attestation.json")
    if report.get("version") != VERSION or report.get("source_version") != "V9.40":
        errors.append("V9.41 report version/source mismatch")
    if manifest.get("decision") != report.get("decision") or manifest.get("safety_flags") != report.get("safety_flags"):
        errors.append("V9.41 manifest mismatch")
    if report.get("dataset_created") is not True:
        errors.append("V9.41 must create the offline supervised dataset")
    ...
    if report.get("leakage_guard", {}).get("status") != "PASS":
        errors.append("V9.41 leakage guard must pass")
    if report.get("forbidden_column_scan", {}).get("status") != "PASS":
        errors.append("V9.41 forbidden column scan must pass")
...
def _check_command_results(extract_root: Path) -> list[str]:
    payload = _read_json(extract_root / "reports/audit_lite/v9_41_command_results.json")
    ...
    for needle in ["pytest --collect-only -q", "test_ohlcv_aggtrades_5y_dataset_v9_41.py", "test_ohlcv_aggtrades_5y_dataset_v9_41_validator.py", "run_ohlcv_aggtrades_5y_dataset_v9_41.py", "validate_ohlcv_aggtrades_5y_dataset_v9_41.py", "release_audit_lite_zip_v9_41.py"]:
...
def _check_state(extract_root: Path) -> list[str]:
    ...
    errors: list[str] = []
    if metrics.get("last_validated_version") != "V9.40":
...
def _write_reports(result: dict[str, Any]) -> None:
    ...
    (report_dir / "zip_audit_v9_41.json").write_text(json.dumps(result, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    (report_dir / "zip_audit_v9_41.md").write_text(
        "# Audit ZIP V9.41\n\n"

...
from galapagos.data.public_trades.ninety_day_window import (
    discover_public_trades_90d_window_v7_7,
    run_public_trades_90d_window_v7_7,
)
...
def main() -> None:
    ...
    if (
        args.start_date != DEFAULT_90D_WINDOW_START_V7_7
        or args.end_date != DEFAULT_90D_WINDOW_END_V7_7
    ...
    manifest = run_public_trades_90d_window_v7_7(
        Path("."),
        no_network=args.no_network,
        force=args.force,

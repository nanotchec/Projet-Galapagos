...
ZIP_NAME = "projet-galapagos-v2.4.6-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_4_6.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_4_6.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_4_6.py",
    "scripts/audit_clean_zip_v2_4_6.py",
    "scripts/smoke_test_clean_zip_v2_4_6.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du smoke test dynamique et finalisation du validateur V2.4.6.\n",
        encoding="utf-8",
    )

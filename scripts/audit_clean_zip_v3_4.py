...
from release_clean_zip_v3_4 import FORBIDDEN_SUFFIXES, INCLUDED_PATHS
...
ESSENTIAL_ENTRIES = [
    "scripts/run_multi_day_ml_robustness_v3_4.py",
    "scripts/validate_multi_day_ml_robustness_v3_4.py",
    "scripts/smoke_test_clean_zip_v3_4.py",
    ...
    "docs/multi_day_ml_robustness_v3_4.md",
]
...
def main() -> None:
    ...
    Path("reports/zip_audit_v3_4.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v3_4.md").write_text(
        "# Audit ZIP V3.4\n\n"

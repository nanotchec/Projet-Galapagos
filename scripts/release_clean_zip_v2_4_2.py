...
ZIP_NAME = "projet-galapagos-v2.4.2-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_4_2.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_4_2.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_4_2.py",
    "scripts/audit_clean_zip_v2_4_2.py",
    "scripts/smoke_test_clean_zip_v2_4_2.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du durcissement manifest/report V2.4.2.\n",
        encoding="utf-8",
    )

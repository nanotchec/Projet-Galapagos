...
REQUIRED = [
    "src/galapagos/features/causal_ohlcv.py",
...
def main() -> None:
    ...
    Path("reports/zip_audit_v2_5_2.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_audit_v2_5_2.md").write_text(
        "# Audit ZIP V2.5.2\n\n"

...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="galapagos_v2_6_smoke_") as tmp:
        ...
        script_check = (
            ...
            "assert manifest_v6['correction_version']=='V2.6.0'\n"
            "assert report_v6['version']=='V2.6'\n"
            "assert report_v6['correction_version']=='V2.6.0'\n"
    ...
    Path("reports/zip_smoke_test_v2_6.json").write_text(json.dumps(payload, indent=2, ensure_ascii=False) + "\n", encoding="utf-8")
    Path("reports/zip_smoke_test_v2_6.md").write_text(
        "# Smoke ZIP V2.6\n\n"

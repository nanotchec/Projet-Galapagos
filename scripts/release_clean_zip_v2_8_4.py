...
ZIP_NAME = "projet-galapagos-v2.8.4-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_8_4.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_8_4.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du laboratoire ML offline V2.8.4.\n",
        encoding="utf-8",
    )

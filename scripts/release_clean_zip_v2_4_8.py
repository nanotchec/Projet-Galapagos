...
ZIP_NAME = "projet-galapagos-v2.4.8-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_4_8.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_4_8.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_4_8.py",
    "scripts/audit_clean_zip_v2_4_8.py",
    "scripts/smoke_test_clean_zip_v2_4_8.py",
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la finalisation du validateur V2.4.8.\n",
        encoding="utf-8",
    )

...
ZIP_NAME = "projet-galapagos-v2.7.2-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_7_2.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_7_2.md")
...
def main() -> None:
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du dataset supervise offline V2.7.2.\n",
        encoding="utf-8",
    )

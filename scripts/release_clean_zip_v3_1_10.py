...
ZIP_NAME = "projet-galapagos-v3.1.10-clean.zip"
REPORT_PATH = Path("reports/release_zip_v3_1_10.json")
REPORT_MD_PATH = Path("reports/release_zip_v3_1_10.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/run_multi_day_label_factory_v3_1.py",
    "scripts/validate_multi_day_label_factory_v3_1.py",
    "scripts/release_clean_zip_v3_1.py",
    "scripts/audit_clean_zip_v3_1.py",
    "scripts/smoke_test_clean_zip_v3_1.py",
    "scripts/release_clean_zip_v3_1_10.py",
    "scripts/audit_clean_zip_v3_1_10.py",
    "scripts/smoke_test_clean_zip_v3_1_10.py",
    ...
    "tests/labels/test_multi_day_forward_labels_v3_1.py",
    "tests/validation/test_multi_day_label_factory_v3_1_validator.py",
    ...
    "reports/labels/multi_day_label_factory_v3_1.md",
    ...
    "docs/multi_day_label_factory_v3_1.md",
...
for tf in TIMEFRAMES:
    INCLUDED_PATHS.extend(
        [
            ...
            f"{V3_1_BASE}/timeframe={tf}/window=2024-01-15_2024-01-21/labels.parquet",
        ]
    )
...
def main() -> None:
    ...
    payload = {
        ...
        "contains_multi_day_labels": True,
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe de la preview label factory forward multi-day V3.1.10.\n",
        encoding="utf-8",
    )

...
ZIP_NAME = "projet-galapagos-v2.6.1-clean.zip"
REPORT_PATH = Path("reports/release_zip_v2_6_1.json")
REPORT_MD_PATH = Path("reports/release_zip_v2_6_1.md")
...
INCLUDED_PATHS = [
    ...
    "scripts/release_clean_zip_v2_6_1.py",
    "scripts/audit_clean_zip_v2_6_1.py",
    "scripts/smoke_test_clean_zip_v2_6_1.py",
    ...
    "data/gold/features/ohlcv/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=1m/year=2024/month=01/features-2024-01-15.parquet",
    "data/gold/features/ohlcv/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=5m/year=2024/month=01/features-2024-01-15.parquet",
    "data/gold/features/ohlcv/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=15m/year=2024/month=01/features-2024-01-15.parquet",
    "data/gold/features/ohlcv/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=1h/year=2024/month=01/features-2024-01-15.parquet",
    ...
    "data/gold/labels/forward_returns/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=5m/year=2024/month=01/labels-2024-01-15.parquet",
    "data/gold/labels/forward_returns/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=15m/year=2024/month=01/labels-2024-01-15.parquet",
    "data/gold/labels/forward_returns/source=binance_archive/market_type=spot/symbol=BTCUSDT/timeframe=1h/year=2024/month=01/labels-2024-01-15.parquet",
    "pyproject.toml",
    "README.md",
]
...
def main() -> None:
    ...
    payload = {
        ...
        "contains_silver_parquet": True,
        "contains_features_gold_parquet": True,
        "contains_labels_gold_parquet": True,
        "contains_labels_validator": True,
        "contains_tests": True,
    ...
    REPORT_MD_PATH.write_text(
        ...
        "- Usage : audit externe du Label Factory V2.6.\n",
        encoding="utf-8",
    )

...
AUDIT_JSON = Path("reports/audit_lite/zip_audit_v5_4_1.json")
AUDIT_MD = Path("reports/audit_lite/zip_audit_v5_4_1.md")
...
REQUIRED_ENTRIES = {
    ...
    "reports/audit_lite/v5_4_full_local_validation_attestation.md",
    ...
    "scripts/run_max_history_offline_ml_research_v5_4.py",
    "scripts/validate_max_history_offline_ml_research_v5_4.py",
...
SAMPLE_ENTRIES = {
    "data/audit_lite/v5_4/ml_scores/timeframe=1m/sample.parquet",
    "data/audit_lite/v5_4/ml_scores/timeframe=5m/sample.parquet",
    "data/audit_lite/v5_4/ml_scores/timeframe=15m/sample.parquet",
    "data/audit_lite/v5_4/ml_scores/timeframe=1h/sample.parquet",
}
FORBIDDEN_PREFIXES = (
    "data/raw/",
    "data/research/",
...
def _result(zip_path: Path, size: int, entries: list[str], errors: list[str], warnings: list[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "test_llm_provider_absent": "scripts/test_llm_provider.py" not in entries,
        "run_forward_paper_test_absent": "scripts/run_forward_paper_test.py" not in entries,

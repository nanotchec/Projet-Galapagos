...
def valid_v2_4_project(tmp_path: Path, valid_v2_4_template: Path) -> Path:
    ...
    shutil.copytree(valid_v2_4_template, destination)
    _sync_copied_ingestion_manifest(destination)
    return destination


def test_validator_v2_4_accepts_valid_resampling(valid_v2_4_project: Path) -> None:
...
def test_validator_v2_4_rejects_wrong_expected_rows(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
    manifest["expected_rows"]["5m"] = 999
    _write_json(valid_v2_4_project / MANIFEST_PATH, manifest)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is False
...
def test_validator_v2_4_rejects_safety_flag_trading_true(valid_v2_4_project: Path) -> None:
    _assert_safety_flag_rejected(valid_v2_4_project, "trading_enabled", "trading_enabled must be false")


def test_validator_v2_4_rejects_safety_flag_ml_true(valid_v2_4_project: Path) -> None:
    _assert_safety_flag_rejected(valid_v2_4_project, "ml_enabled", "ml_enabled must be false")


def test_validator_v2_4_rejects_safety_flag_labels_true(valid_v2_4_project: Path) -> None:
    _assert_safety_flag_rejected(valid_v2_4_project, "labels_enabled", "labels_enabled must be false")


def test_validator_v2_4_rejects_safety_flag_backtest_true(valid_v2_4_project: Path) -> None:
    _assert_safety_flag_rejected(valid_v2_4_project, "backtest_enabled", "backtest_enabled must be false")


def test_validator_v2_4_rejects_safety_flag_orders_true(valid_v2_4_project: Path) -> None:
    _assert_safety_flag_rejected(valid_v2_4_project, "orders_enabled", "orders_enabled must be false")


def test_validator_v2_4_rejects_manifest_quality_rows_lie_even_if_report_synced(valid_v2_4_project: Path) -> None:
    _set_manifest_and_report_quality_field(valid_v2_4_project, "5m", "rows", 123)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is False
    assert "V2.4 manifest quality mismatch for 5m.rows" in result["errors"]


def test_validator_v2_4_rejects_manifest_quality_gap_count_lie_even_if_report_synced(valid_v2_4_project: Path) -> None:
    _set_manifest_and_report_quality_field(valid_v2_4_project, "15m", "gap_count", 99)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is False
    assert "V2.4 manifest quality mismatch for 15m.gap_count" in result["errors"]


def test_validator_v2_4_rejects_manifest_quality_monotonic_lie_even_if_report_synced(valid_v2_4_project: Path) -> None:
    _set_manifest_and_report_quality_field(valid_v2_4_project, "1h", "monotonic_event_ts", False)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is False
...
def test_validator_v2_4_rejects_quality_report_output_checksum_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
    report["outputs"]["5m"]["sha256"] = "bad"
    _write_json(valid_v2_4_project / QUALITY_JSON_PATH, report)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is False
    assert "quality report outputs mismatch" in result["errors"]


def test_validator_v2_4_rejects_quality_report_input_sha_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_quality_report_expected_rows_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_quality_report_parent_child_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_quality_report_resampling_run_id_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_quality_report_created_at_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_quality_report_limitations_lie(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
    report["limitations"] = []
    _write_json(valid_v2_4_project / QUALITY_JSON_PATH, report)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
...
def test_validator_v2_4_rejects_quality_report_unexpected_top_level_key(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_quality_report_top_level_trading_enabled_true(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_rejects_manifest_unexpected_top_level_key(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_manifest_unexpected_execution_key(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_output_unexpected_key(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_quality_unexpected_key(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_report_safety_unexpected_key(valid_v2_4_project: Path) -> None:
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
...
def test_validator_v2_4_allows_markdown_negative_safety_claims(valid_v2_4_project: Path) -> None:
    markdown_path = valid_v2_4_project / "reports/data_quality/ohlcv_resampling_v2_4.md"
...
def test_validator_v2_4_rejects_synced_limitations_strategy_validated_claim(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_synced_limitations_trading_enabled_claim(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_empty_synced_limitations(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_invalid_created_at_even_if_report_synced(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_rejects_invalid_resampling_run_id_even_if_report_synced(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
...
def test_validator_v2_4_allows_expected_limitations(valid_v2_4_project: Path) -> None:
    manifest = _load_json(valid_v2_4_project / MANIFEST_PATH)
    report = _load_json(valid_v2_4_project / QUALITY_JSON_PATH)
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is True
...
def test_validator_v2_4_rejects_included_v2_3_manifest_strategy_validated_claim(
    valid_v2_4_project: Path,
) -> None:
...
def test_validator_v2_4_rejects_included_v2_3_markdown_strategy_claim(valid_v2_4_project: Path) -> None:
    ...
    result = validate_ohlcv_resampling_v2_4(valid_v2_4_project)
    assert result["passed"] is False
    assert any("V2.3 quality markdown contains forbidden claim" in error for error in result["errors"])

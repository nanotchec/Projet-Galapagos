...
from galapagos.ml.ohlcv_trades_1y_robustness import (
    ...
    compute_ohlcv_trades_1y_vs_references_comparison_v8_6,
    compute_ohlcv_trades_baseline_delta_v8_6,
    compute_ohlcv_trades_split_stability_v8_6,
    compute_ohlcv_trades_timeframe_stability_v8_6,
    compute_ohlcv_trades_walk_forward_stability_v8_6,
    run_ohlcv_trades_1y_ml_robustness_v8_6,
    scan_ohlcv_trades_feature_leakage_v8_6,
    scan_ohlcv_trades_metric_forbidden_terms_v8_6,
)


def test_baseline_delta_contains_majority_and_random_comparisons_v8_6() -> None:
    delta = compute_ohlcv_trades_baseline_delta_v8_6(_metrics())
...
def test_split_stability_computes_train_validation_test_gaps_v8_6() -> None:
    stability = compute_ohlcv_trades_split_stability_v8_6(_metrics())
...
def test_timeframe_stability_contains_all_timeframes_v8_6() -> None:
    stability = compute_ohlcv_trades_timeframe_stability_v8_6(_metrics())
...
def test_walk_forward_stability_contains_groups_v8_6() -> None:
    stability = compute_ohlcv_trades_walk_forward_stability_v8_6(_walk_forward_metrics())
    logistic = stability["1m.logistic_regression"]
...
def test_ohlcv_trades_1y_vs_references_comparison_is_descriptive_v8_6(tmp_path: Path) -> None:
    ...
    comparison = compute_ohlcv_trades_1y_vs_references_comparison_v8_6(
        tmp_path,
        {
...
def test_label_shuffle_falsification_uses_seed_123_v8_6() -> None:
    assert LABEL_SHUFFLE_RANDOM_SEED_V8_6 == 123


def test_feature_leakage_scan_rejects_future_label_split_features_v8_6() -> None:
    scan = scan_ohlcv_trades_feature_leakage_v8_6(
...
def test_feature_leakage_scan_allows_causal_trade_features_v8_6() -> None:
    scan = scan_ohlcv_trades_feature_leakage_v8_6(["agg_trade_count", "taker_buy_ratio_quantity"])

    assert scan["feature_leakage_detected"] is False
    assert scan["forbidden_feature_columns_present"] == []


def test_metric_forbidden_scan_rejects_trading_metrics_v8_6() -> None:
    scan = scan_ohlcv_trades_metric_forbidden_terms_v8_6({"model": {"sharpe": 1.0, "drawdown": 0.2}})

    assert scan["metric_forbidden_terms_detected"] is True
    assert scan["forbidden_terms_present"] == ["sharpe", "drawdown"]


def test_no_robust_edge_claimed_by_default_v8_6() -> None:
    source = inspect.getsource(run_ohlcv_trades_1y_ml_robustness_v8_6)
...
def test_ohlcv_trades_not_validated_for_trading_by_default_v8_6() -> None:
    source = inspect.getsource(run_ohlcv_trades_1y_ml_robustness_v8_6)

...
from galapagos.ml.expanded_window_robustness import (
    ...
    compute_expanded_baseline_delta_v4_0,
    compute_expanded_split_stability_v4_0,
    compute_expanded_timeframe_stability_v4_0,
    run_expanded_ml_robustness_v4_0,
    scan_expanded_feature_leakage_v4_0,
    scan_expanded_metric_forbidden_terms_v4_0,
)


def test_baseline_delta_contains_majority_and_random_comparisons_v4_0() -> None:
    delta = compute_expanded_baseline_delta_v4_0(_metrics())
...
def test_split_stability_computes_train_validation_test_gaps_v4_0() -> None:
    stability = compute_expanded_split_stability_v4_0(_metrics())
...
def test_timeframe_stability_contains_all_timeframes_v4_0() -> None:
    stability = compute_expanded_timeframe_stability_v4_0(_metrics())
...
def test_label_shuffle_falsification_uses_seed_123_v4_0() -> None:
    assert LABEL_SHUFFLE_RANDOM_SEED_V4_0 == 123


def test_feature_leakage_scan_rejects_future_label_split_features_v4_0() -> None:
    scan = scan_expanded_feature_leakage_v4_0(["return_1", "future_log_return_h1", "label_valid_h1", "split"])
...
def test_metric_forbidden_scan_rejects_trading_metrics_v4_0() -> None:
    scan = scan_expanded_metric_forbidden_terms_v4_0({"model": {"sharpe": 1.0, "drawdown": 0.2}})

    assert scan["metric_forbidden_terms_detected"] is True
    assert scan["forbidden_terms_present"] == ["sharpe", "drawdown"]


def test_no_robust_edge_claimed_by_default_v4_0() -> None:
    source = inspect.getsource(run_expanded_ml_robustness_v4_0)

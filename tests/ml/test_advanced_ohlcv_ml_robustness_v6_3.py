...
from galapagos.ml.advanced_ohlcv_robustness import (
    ...
    compute_advanced_vs_simple_comparison_v6_3,
    compute_advanced_ohlcv_baseline_delta_v6_3,
    compute_advanced_ohlcv_split_stability_v6_3,
    compute_advanced_ohlcv_timeframe_stability_v6_3,
    compute_advanced_ohlcv_walk_forward_stability_v6_3,
    run_advanced_ohlcv_ml_robustness_v6_3,
    scan_advanced_ohlcv_feature_leakage_v6_3,
    scan_advanced_ohlcv_metric_forbidden_terms_v6_3,
)


def test_baseline_delta_contains_majority_and_random_comparisons_v6_3() -> None:
    delta = compute_advanced_ohlcv_baseline_delta_v6_3(_metrics())
...
def test_split_stability_computes_train_validation_test_gaps_v6_3() -> None:
    stability = compute_advanced_ohlcv_split_stability_v6_3(_metrics())
...
def test_timeframe_stability_contains_all_timeframes_v6_3() -> None:
    stability = compute_advanced_ohlcv_timeframe_stability_v6_3(_metrics())
...
def test_walk_forward_stability_contains_groups_v6_3() -> None:
    stability = compute_advanced_ohlcv_walk_forward_stability_v6_3(_walk_forward_metrics())
    logistic = stability["1m.logistic_regression"]
...
def test_advanced_vs_simple_comparison_is_descriptive_v6_3(tmp_path: Path) -> None:
    ...
    comparison = compute_advanced_vs_simple_comparison_v6_3(
        tmp_path,
        {
    ...
    assert comparison["advanced_better_count"] == 1
    assert comparison["split_metric_comparisons"]["1m.logistic_regression.test"]["delta_advanced_minus_simple_macro_f1"] == 0.05


def test_label_shuffle_falsification_uses_seed_123_v6_3() -> None:
    assert LABEL_SHUFFLE_RANDOM_SEED_V6_3 == 123


def test_feature_leakage_scan_rejects_future_label_split_features_v6_3() -> None:
    scan = scan_advanced_ohlcv_feature_leakage_v6_3(
...
def test_feature_leakage_scan_allows_macd_like_signal_v6_3() -> None:
    scan = scan_advanced_ohlcv_feature_leakage_v6_3(["return_1", "macd_like_signal"])

    assert scan["feature_leakage_detected"] is False
    assert scan["macd_like_signal_allowed"] is True
    assert scan["forbidden_feature_columns_present"] == []


def test_metric_forbidden_scan_rejects_trading_metrics_v6_3() -> None:
    scan = scan_advanced_ohlcv_metric_forbidden_terms_v6_3({"model": {"sharpe": 1.0, "drawdown": 0.2}})

    assert scan["metric_forbidden_terms_detected"] is True
    assert scan["forbidden_terms_present"] == ["sharpe", "drawdown"]


def test_no_robust_edge_claimed_by_default_v6_3() -> None:
    source = inspect.getsource(run_advanced_ohlcv_ml_robustness_v6_3)
...
def test_advanced_features_not_validated_for_trading_by_default_v6_3() -> None:
    source = inspect.getsource(run_advanced_ohlcv_ml_robustness_v6_3)

    assert '"advanced_features_validated_for_trading": False' in source

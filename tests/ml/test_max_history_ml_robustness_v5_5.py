...
from galapagos.ml.max_history_robustness import (
    ...
    compute_max_history_baseline_delta_v5_5,
    compute_max_history_split_stability_v5_5,
    compute_max_history_timeframe_stability_v5_5,
    compute_max_history_walk_forward_stability_v5_5,
    run_max_history_ml_robustness_v5_5,
    scan_max_history_feature_leakage_v5_5,
    scan_max_history_metric_forbidden_terms_v5_5,
)


def test_baseline_delta_contains_majority_and_random_comparisons_v5_5() -> None:
    delta = compute_max_history_baseline_delta_v5_5(_metrics())
...
def test_split_stability_computes_train_validation_test_gaps_v5_5() -> None:
    stability = compute_max_history_split_stability_v5_5(_metrics())
...
def test_timeframe_stability_contains_all_timeframes_v5_5() -> None:
    stability = compute_max_history_timeframe_stability_v5_5(_metrics())
...
def test_walk_forward_stability_contains_groups_v5_5() -> None:
    stability = compute_max_history_walk_forward_stability_v5_5(_walk_forward_metrics())
    logistic = stability["1m.logistic_regression"]
...
def test_label_shuffle_falsification_uses_seed_123_v5_5() -> None:
    assert LABEL_SHUFFLE_RANDOM_SEED_V5_5 == 123


def test_feature_leakage_scan_rejects_future_label_split_features_v5_5() -> None:
    scan = scan_max_history_feature_leakage_v5_5(
...
def test_metric_forbidden_scan_rejects_trading_metrics_v5_5() -> None:
    scan = scan_max_history_metric_forbidden_terms_v5_5({"model": {"sharpe": 1.0, "drawdown": 0.2}})

    assert scan["metric_forbidden_terms_detected"] is True
    assert scan["forbidden_terms_present"] == ["sharpe", "drawdown"]


def test_no_robust_edge_claimed_by_default_v5_5() -> None:
    source = inspect.getsource(run_max_history_ml_robustness_v5_5)

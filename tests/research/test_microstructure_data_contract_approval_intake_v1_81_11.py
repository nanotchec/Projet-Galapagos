...
def test_negative_coverage_report_uses_requested_version():
    nc = NegativeCoverage()
    res = nc.get_coverage_report(version="V1.81.11", corrective_for_version="V1.81.10")
    assert res["version"] == "V1.81.11"
    assert res["corrective_for_version"] == "V1.81.10"
